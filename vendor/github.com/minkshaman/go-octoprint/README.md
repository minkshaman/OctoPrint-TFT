go-octoprint [![Build Status](https://travis-ci.org/minkshaman/go-octoprint.svg?branch=master)](https://travis-ci.org/minkshaman/go-octoprint) [![GoDoc](http://godoc.org/github.com/minkshaman/go-octoprint?status.svg)](http://godoc.org/github.com/minkshaman/go-octoprint)
==============================
...
```
go get github.com/minkshaman/go-octoprint
```
